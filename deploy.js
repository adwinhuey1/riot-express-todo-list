...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    '../riot-express-todo-temp',
    '/home/ubuntu/riot-express-todo-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-express-todo-temp && mkdir riot-express-todo-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r riot-express-todo-temp/* riot-express-todo/ && rm -rf riot-express-todo-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd riot-express-todo && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
